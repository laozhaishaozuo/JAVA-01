package top.shaozuo.geektime.java01.week03.gateway02.outbound.httpclient4;
...
import top.shaozuo.geektime.java01.week03.gateway02.filter.HttpResponseFilter;
...
public class HttpOutboundHandler {
    ...
    public HttpOutboundHandler(List<String> backends) {
        ...
        IOReactorConfig ioConfig = IOReactorConfig.custom().setConnectTimeout(1000)
                .setSoTimeout(1000).setIoThreadCount(cores).setRcvBufSize(32 * 1024).build();
    ...
    public void handle(final FullHttpRequest fullRequest, final ChannelHandlerContext ctx,
        ...
        String backendUrl = backendUrls.get(0);
    ...
    private void fetchGet(final FullHttpRequest inbound, final ChannelHandlerContext ctx,
        ...
        httpGet.setHeader("shaozuo", inbound.headers().get("shaozuo"));
