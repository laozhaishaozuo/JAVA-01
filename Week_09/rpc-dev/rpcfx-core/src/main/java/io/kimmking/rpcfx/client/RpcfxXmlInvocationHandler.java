...
public class RpcfxXmlInvocationHandler implements InvocationHandler {
	...
	public <T> RpcfxXmlInvocationHandler(Class<T> serviceClass, String url, Filter... filters) {
		this(serviceClass, url, new OkHttpRemoteClient(), filters);
	}

	public <T> RpcfxXmlInvocationHandler(Class<T> serviceClass, String url,
